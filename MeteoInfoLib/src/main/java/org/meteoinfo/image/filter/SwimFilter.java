...
import org.meteoinfo.image.math.*;
...
public class SwimFilter extends TransformFilter {
     ...
     *
     * @param amount the amount of swim min-value 0 max-value 100+
     * @see #getAmount
     */
     ...
     *
     * @param scale the scale of the distortion. min-value 1 max-value 300+
     * @see #getScale
     */
     ...
     *
     * @param stretch the stretch factor of the distortion. min-value 1
     * max-value 50+
     * @see #getStretch
     */
