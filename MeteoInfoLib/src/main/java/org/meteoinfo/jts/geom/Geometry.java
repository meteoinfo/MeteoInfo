...
import org.meteoinfo.jts.operation.*;
import org.meteoinfo.jts.operation.buffer.BufferOp;
import org.meteoinfo.jts.operation.distance.DistanceOp;
import org.meteoinfo.jts.operation.linemerge.LineMerger;
import org.meteoinfo.jts.operation.overlay.OverlayOp;
import org.meteoinfo.jts.operation.union.UnaryUnionOp;
import org.meteoinfo.jts.operation.overlay.snap.SnapIfNeededOverlayOp;
import org.meteoinfo.jts.operation.predicate.RectangleIntersects;
import org.meteoinfo.jts.operation.predicate.RectangleContains;
import org.meteoinfo.jts.operation.relate.RelateOp;
import org.meteoinfo.jts.operation.valid.IsValidOp;
...
//      return other.intersection(this);
  ...
  protected void checkNotGeometryCollection(Geometry g) {
    ...
    if (g.getClass().getName().equals("org.meteoinfo.jts.geom.GeometryCollection")) {
  ...
  {
    return getClass().equals(org.meteoinfo.jts.geom.GeometryCollection.class);
  }
