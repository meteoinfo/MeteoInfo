    ...
    implements CoordinateSequence
{
  ...
  /**
   * @see org.meteoinfo.jts.geom.CoordinateSequence#getDimension()
   */
  ...
  /**
   * @see org.meteoinfo.jts.geom.CoordinateSequence#getCoordinate(int)
   */
  ...
  /**
   * @see org.meteoinfo.jts.geom.CoordinateSequence#toCoordinateArray()
   */
...
// testing - never cache
  ...
  /**
   * @see org.meteoinfo.jts.geom.CoordinateSequence#getX(int)
   */
  ...
  /**
   * @see org.meteoinfo.jts.geom.CoordinateSequence#getY(int)
   */
  ...
  public static class Double extends PackedCoordinateSequence {
    ...
    /**
     * @see org.meteoinfo.jts.geom.PackedCoordinateSequence#setOrdinate(int,
     *      int, double)
     */
