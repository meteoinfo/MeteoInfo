    ...
    CoordinateSequenceFactory
{
  ...
  /**
   * @see org.meteoinfo.jts.geom.CoordinateSequenceFactory#create(org.meteoinfo.jts.geom.Coordinate[])
   */
  ...
  /**
   * @see org.meteoinfo.jts.geom.CoordinateSequenceFactory#create(org.meteoinfo.jts.geom.CoordinateSequence)
   */
  ...
  /**
   * @see org.meteoinfo.jts.geom.CoordinateSequenceFactory#create(double[],
   *      int)
   */
  ...
  /**
   * @see org.meteoinfo.jts.geom.CoordinateSequenceFactory#create(float[],
   *      int)
   */
