 ...
 * @author Yaqiang Wang
 */
public class ProjLonLatAxisBackup extends LonLatAxis{
     ...
     */
    public ProjLonLatAxisBackup(String label, boolean isX, ProjectionInfo proj){
        super(label, isX);
        this.proj = proj;
    }
     ...
     */
    public ProjLonLatAxisBackup(String label, boolean isX, ProjectionInfo proj, double xy){
        super(label, isX);
        this.proj = proj;
        this.x_y = xy;
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        return (ProjLonLatAxisBackup)super.clone();
    }
    // </editor-fold>
}
