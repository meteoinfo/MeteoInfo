 ...
 */
package org.meteoinfo.geo.data;
...
import org.meteoinfo.geo.analysis.ResampleMethods;
import org.meteoinfo.geo.util.LegendManage;
...
import org.meteoinfo.geo.projection.Reproject;
...
public class GridArray {
    ...
    public boolean getMaxMinValue(double[] maxmin) {
        ...
        while (iter.hasNext()) {
            ...
            if (Double.isNaN(v) || MIMath.doubleEquals(v, missingValue)) {
                hasUndef = true;
                continue;
            }
