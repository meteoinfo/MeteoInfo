...
public class FrmLegendBreaks extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextField_StartValue.setPreferredSize(new Dimension(89, 24));

        jLabel_To.setText("to:");

        jTextField_EndValue.setPreferredSize(new Dimension(89, 24));

        jLabel_Interval.setText("Interval:");

        jTextField_Interval.setPreferredSize(new Dimension(89, 24));
