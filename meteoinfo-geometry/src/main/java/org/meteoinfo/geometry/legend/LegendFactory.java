...
public class LegendFactory {
    ...
    public static LegendScheme createUniqValueLegendScheme(int n, ShapeTypes aST) {
        ...
        if (n <= 13) {
            colors = LegendFactory.createRainBowColors(n);
        } else {
            colors = LegendFactory.createRandomColors(n);
        }
    ...
    public static LegendScheme createUniqValueLegendScheme(List<Number> values, ShapeTypes aST) {
        ...
        return LegendFactory.createUniqValueLegendScheme(values, colors, aST);
    }
...
//                            aPGB.Style = (HatchStyle)i;
    ...
    public static LegendScheme createLegendScheme(ShapeTypes shapeType, List<Number> values, List<Color> colors) {
        ...
        if (values.size() == colors.size()) {
            ls = LegendFactory.createUniqValueLegendScheme(values, cols, shapeType);
        } else {
            int n = values.size();
            ...
            ls = LegendFactory.createGraduatedLegendScheme(vals, cols, shapeType, min, max);
        }
    ...
    public static LegendScheme createLegendScheme(TransferFunction transferFunction) {
        ...
        LegendScheme ls = LegendFactory.createGraduatedLegendScheme(values, colors, ShapeTypes.POLYGON,
