...
class Axes3DGL(Axes3D):
    ...
    def contourf(self, *args, **kwargs):
        ...
        :returns: (*graphics*) Contour filled polygons created from array data.
        """
        zdir = 'z'
        if kwargs.has_key('zdir'):
            zdir = kwargs['zdir']
        if zdir == 'x' or zdir == 'y':
            if not kwargs.has_key('random_shift'):
                kwargs['random_shift'] = -6
                
        return super(Axes3DGL, self).contourf(*args, **kwargs)
