...
public class GLOPSolver {
    ...
    public static Result solve(double[] c,
        ...
        try {
            ...
            // Create the GLOP solver via OR‑Tools
            MPSolver solver = MPSolver.createSolver("GLOP");
            if (solver == null) {
                Result res = new Result();
                res.success = false;
                res.message = "Could not create GLOP solver (check OR‑Tools native libraries).";
                return res;
            }
            ...
            if (status == MPSolver.ResultStatus.OPTIMAL) {
                ...
                result.success = true;
                result.message = "Optimization terminated successfully (GLOP via OR-Tools).";
                result.x = x;
    ...
    public static void main(String[] args) {
        ...
        Result res = GLOPSolver.solve(c, A_ub, b_ub, null, null, bounds);
